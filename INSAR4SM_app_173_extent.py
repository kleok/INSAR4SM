...
projectname = 'INSAR4SM_estimations_173_sq250_extent'

# the directory of the topstack processing stack
topstackDir = '/RSL02/SM_NA/Topstack_processing_orbit_173'

# time of Sentinel-1 pass.
orbit_time = '14:00:00'

# the AOI geojson file, ensure that AOI is inside your topstack stack
AOI = '/RSL02/SM_NA/Plotting/bbox_aoi_extent.geojson'
...
meteo_file = '/RSL02/SM_NA/era5/era5_land_na_orbit_173.nc'
